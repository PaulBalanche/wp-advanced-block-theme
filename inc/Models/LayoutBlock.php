...
class LayoutBlock extends ModelBase
{
    ...
    {
        return ABT_PLUGIN_DIR .
            $this->get_config()->get("layoutBlocksLocation") .
            $this->get_ID();
    }
    ...
    public function define_view_path()
    {
        ...
        $this->view_path =
            is_array($block_spec) &&
            isset($block_spec["path"]) &&
            !is_null($block_spec["path"])
                ? $block_spec["path"]
                : $this->get_ID();
    }
    ...
    public function render($attributes, $content, $block_instance)
    {
        ...
        $attributes = apply_filters(
            "Abt\pre_render_attributes_layout_" . $this->get_ID(),
            $attributes,
            $content,
            $block_instance
        );
    ...
    public function register()
    {
        ...
        register_block_type(
            $this->get_config()->get("blocksNamespace") . "/" . $this->get_ID(),
            [
    ...
    public function generate_block_spec($component_frontspec)
    {
        ...
        $this->blockSpec = apply_filters(
            "Abt\generate_layout_block_spec",
            [
