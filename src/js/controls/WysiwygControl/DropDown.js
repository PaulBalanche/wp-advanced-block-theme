        ...
        this.props.items.forEach( item => {
            ...
            if( item.children ) {
                ...
                item.children.forEach( child => {
                    ...
                    childrenItems.push(
                        <div
                            ...
                            onMouseDown={(e) => this.handleClick(child.style, e)}
                        >
                            <div className="wpe-dropdown-list-item-inner" style={child.buttonStyle}>{child.label}</div>
                        </div>);
                });
                ...
                listItems.push(
                    ...
                    >
                        <div className="wpe-dropdown-list-item-cat" >{item.label}</div>
                        <div className="wpe-dropdown-list-item-children-list" >{childrenItems}</div>
                    </div>);
            }
            else {
                ...
                listItems.push(
                    ...
                    >
                        <div className="wpe-dropdown-list-item-inner" style={item.buttonStyle}>{item.label}</div>
                    </div>);
            }
        });
        ...
        return (
            <div id={ "dropdown-" + this.props.id} className="wpe-dropdown-container">
                ...
                <div ref={this.wrapperRef} key={this.props.id} className="wpe-dropdown-wrapper">
                    ...
                    {this.state.isListOpen && (
                    <div key={this.props.id + 'items'} className="wpe-dropdown-list">{ this.renderListItems() }</div>
                    )}
                </div>
            </div>
        );
