...
export function renderImageVideo(
    componentInstance,
    type,
    args,
    id,
    ...
    if (type == "image") {
        ...
        imageVideoControl.push(
            Render.fieldContainer(id + "_video", <VideoRadioControl />)
        );
